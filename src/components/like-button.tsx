...
export function LikeButton({ id, size = 32 }: LikeButtonProps) {
      ...
      >
        {isLiked && (
          <path
            opacity=".3"
            fill="currentColor"
            className="text-pink-500 animate__animated animate__fadeIn"
        ...
        <path
          ...
          className={clsx("animate__animated animate__fadeIn", {
            "text-pink-600": isLiked,
            "text-slate-400": !isLiked,
          })}
